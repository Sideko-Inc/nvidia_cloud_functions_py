...
def test_create_200_success_default():
    ...
    Response : typing.Union[models.PexecFunctionsCreateResponseObj, typing.List[models.PexecFunctionsCreateResponseArrItem]]
    ...
    response = client.pexec.functions.create(
        data={}, function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    try:
        pydantic.TypeAdapter(models.PexecFunctionsCreateResponseObj).validate_python(
            response
        )
        is_json = True
...
async def test_await_create_200_success_default():
    ...
    response = await client.pexec.functions.create(
        data={}, function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    try:
        pydantic.TypeAdapter(models.PexecFunctionsCreateResponseObj).validate_python(
