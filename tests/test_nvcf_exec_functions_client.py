...
def test_create_200_success_default():
    """Tests a POST request to the /v2/nvcf/exec/functions/{functionId} endpoint.
    ...
    response = client.nvcf.exec.functions.create(
...
async def test_await_create_200_success_default():
    ...
    response = await client.nvcf.exec.functions.create(
        function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", request_body={}
    )
    try:
        pydantic.TypeAdapter(models.InvokeFunctionResponse).validate_python(response)
