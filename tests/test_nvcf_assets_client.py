...
def test_create_200_success_default():
    ...
    response = client.nvcf.assets.create(content_type="string", description="string")
    try:
...
async def test_await_create_200_success_default():
    ...
    response = await client.nvcf.assets.create(
...
def test_get_200_generated_success():
    ...
    # tests calling sync method with example data
    client = Client(environment=Environment.MOCK_SERVER)
    response = client.nvcf.assets.get(asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
    try:
...
async def test_await_get_200_generated_success():
    ...
    # tests calling async method with example data
    client = AsyncClient(environment=Environment.MOCK_SERVER)
    response = await client.nvcf.assets.get(
...
def test_delete_204_generated_success():
    ...
    # tests calling sync method with example data
    client = Client(environment=Environment.MOCK_SERVER)
    response = client.nvcf.assets.delete(
        asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
...
async def test_await_delete_204_generated_success():
    ...
    # tests calling async method with example data
    client = AsyncClient(environment=Environment.MOCK_SERVER)
    response = await client.nvcf.assets.delete(
        asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    assert response is None
