...
def test_get_200_generated_success():
    """Tests a GET request to the /v2/nvcf/queues/functions/{functionId}/versions/{versionId} endpoint.
    ...
    response = client.nvcf.queues.functions.versions.get(
...
async def test_await_get_200_generated_success():
    ...
    response = await client.nvcf.queues.functions.versions.get(
        function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    )
    try:
