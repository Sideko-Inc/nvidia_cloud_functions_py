...
def test_create_200_success_default():
    ...
    Response : typing.Union[models.PexecFunctionsVersionsCreateResponseObj, typing.List[models.PexecFunctionsVersionsCreateResponseArrItem]]
    ...
    response = client.pexec.functions.versions.create(
        data={},
    ...
    try:
        pydantic.TypeAdapter(
            models.PexecFunctionsVersionsCreateResponseObj
    ...
    try:
        pydantic.TypeAdapter(
            typing.List[models.PexecFunctionsVersionsCreateResponseArrItem]
        ).validate_python(response)
        is_stream = True
    except pydantic.ValidationError:
        is_stream = False
...
async def test_await_create_200_success_default():
    ...
    response = await client.pexec.functions.versions.create(
        data={},
        function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    )
