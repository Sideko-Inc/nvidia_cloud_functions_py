...
def test_patch_200_success_default():
    """Tests a PATCH request to the /v2/nvcf/authorizations/functions/{functionId}/versions/{functionVersionId}/add endpoint.
    ...
    response = client.nvcf.authorizations.functions.versions.add.patch(
...
async def test_await_patch_200_success_default():
    ...
    response = await client.nvcf.authorizations.functions.versions.add.patch(
        authorized_party={"nca_id": "string"},
        function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    )
