...
class StatusClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.pexec.status.get(request_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```

        """
        return self._base_client.request(
            method="GET",
            path=f"/v2/nvcf/pexec/status/{request_id}",
            cast_to=models.PexecStatusGetResponse,
...
class AsyncStatusClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.pexec.status.get(request_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
