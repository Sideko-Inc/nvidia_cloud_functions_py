...
from nvidia_cloud_functions.resources.queues.functions.versions import (
    AsyncVersionsClient,
    VersionsClient,
)
...
class FunctionsClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.queues.functions.get(function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
...
class AsyncFunctionsClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.queues.functions.get(
