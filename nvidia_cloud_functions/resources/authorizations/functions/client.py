...
from nvidia_cloud_functions.resources.authorizations.functions.versions import (
    AsyncVersionsClient,
    VersionsClient,
)
from nvidia_cloud_functions.resources.authorizations.functions.add import (
    AddClient,
    AsyncAddClient,
)
from nvidia_cloud_functions.resources.authorizations.functions.remove import (
    AsyncRemoveClient,
    RemoveClient,
)
...
class AsyncFunctionsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.authorizations.functions.delete(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.authorizations.functions.get(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.authorizations.functions.create(
            authorized_parties=[{"nca_id": "string"}],
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
        ```
