...
from nvidia_cloud_functions_py.resources.nvcf.authorizations.functions.versions.add import (
    AddClient,
    AsyncAddClient,
)
from nvidia_cloud_functions_py.resources.nvcf.authorizations.functions.versions.remove import (
    AsyncRemoveClient,
    RemoveClient,
)
...
class AsyncVersionsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.authorizations.functions.versions.delete(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.authorizations.functions.versions.get(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.authorizations.functions.versions.create(
            authorized_parties=[{"nca_id": "string"}],
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
