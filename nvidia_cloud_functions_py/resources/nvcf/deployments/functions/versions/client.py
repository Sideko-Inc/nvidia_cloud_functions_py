...
class AsyncVersionsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.deployments.functions.versions.delete(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.deployments.functions.versions.get(
            function_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            function_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.deployments.functions.versions.create(
            deployment_specifications=[
                {
                    "backend": "string",
                    "gpu": "string",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.deployments.functions.versions.update(
            deployment_specifications=[
                {
                    "backend": "string",
                    "gpu": "string",
