...
class StatusClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.NvcfPexecStatusGetResponse:
        """
        ...
        Examples:
        ```py
        client.nvcf.pexec.status.get(request_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        ...
        return self._base_client.request(
            ...
            cast_to=models.NvcfPexecStatusGetResponse,
...
class AsyncStatusClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.pexec.status.get(
