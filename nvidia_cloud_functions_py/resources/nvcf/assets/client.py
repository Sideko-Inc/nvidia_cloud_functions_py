...
class AssetsClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.nvcf.assets.delete(asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
    ...
    def get(
        ...
        Examples:
        ```py
        client.nvcf.assets.get(asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.nvcf.assets.create(content_type="string", description="string")
        ```
...
class AsyncAssetsClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.nvcf.assets.delete(asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.nvcf.assets.get(asset_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.nvcf.assets.create(content_type="string", description="string")
        ```
